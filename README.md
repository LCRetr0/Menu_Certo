...
Buscar por Filtros / Categoria / País:
GET /api/produtos/buscar?pais={pais}&nutriscore={grade}&nova={grupo}&termo={termo}&restricao={gluten|lactose}
...
Bash
git clone https://github.com/seu-usuario/MenuCerto.git
